...
| E0 / RD1 | Can PKC inventory repository shape and safely exclude only proven generated/restorable areas before expensive semantic scanning? | **ACTIVE** |
...
```text
RD1 inventory + safe exclusion — START NOW
```

## Version semantics

```text
roadmap: V0.4.7-E0 bounded prework active; RD1 current; R7.10/D still open
